...
package io.debezium.connector.pgsql.connection.pgproto;
...
import io.debezium.connector.pgsql.connection.ReplicationMessage;
import io.debezium.connector.pgsql.connection.ReplicationMessageColumnValueResolver;
import io.debezium.connector.pgsql.proto.PgProto;
...
class PgProtoReplicationMessage implements ReplicationMessage {
    ...
    public Object getValue(String columnName, PostgresType type, String fullType, PgProto.DatumMessage datumMessage,
