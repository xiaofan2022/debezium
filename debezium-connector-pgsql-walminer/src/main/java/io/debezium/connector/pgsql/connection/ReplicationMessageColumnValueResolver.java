...
public class ReplicationMessageColumnValueResolver {
    ...
    /**
     * Resolve the value of a {@link ReplicationMessage.ColumnValue}.
     *
     ...
     * @return
     */
    public static Object resolveValue(String columnName, PostgresType type, String fullType, ReplicationMessage.ColumnValue value,
